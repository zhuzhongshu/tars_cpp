 ...
 * json类型的基类。没有任何意义
 */
class JsonValue : public tars::TC_HandleBase
{
public:
    virtual eJsonType getType()=0;
    virtual ~JsonValue(){}
};
typedef tars::TC_AutoPtr<JsonValue> JsonValuePtr;
...
typedef tars::TC_AutoPtr<JsonValueString> JsonValueStringPtr;
...
typedef tars::TC_AutoPtr<JsonValueNum> JsonValueNumPtr;
...
typedef tars::TC_AutoPtr<JsonValueObj> JsonValueObjPtr;
...
typedef tars::TC_AutoPtr<JsonValueArray> JsonValueArrayPtr;
...
typedef tars::TC_AutoPtr<JsonValueBoolean> JsonValueBooleanPtr;
