...
namespace tars
{
    ...
    public:
        ...
        tars::JsonValueObjPtr writeToJson() const
        {
            ...
            p->value["avg1"] = tars::JsonOutput::writeJson(avg1);
            p->value["avg5"] = tars::JsonOutput::writeJson(avg5);
            p->value["avg15"] = tars::JsonOutput::writeJson(avg15);
            if (avgCpu != 0)
            {
                p->value["avgCpu"] = tars::JsonOutput::writeJson(avgCpu);
            }
            return p;
        }
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonInput::readJson(avg1,pObj->value["avg1"], true);
            tars::JsonInput::readJson(avg5,pObj->value["avg5"], true);
            tars::JsonInput::readJson(avg15,pObj->value["avg15"], true);
            tars::JsonInput::readJson(avgCpu,pObj->value["avgCpu"], false);
        }
    ...
    public:
        ...
        {
            tars::JsonValueObjPtr p = new tars::JsonValueObj();
            p->value["bPatching"] = tars::JsonOutput::writeJson(bPatching);
            p->value["iPercent"] = tars::JsonOutput::writeJson(iPercent);
            p->value["iModifyTime"] = tars::JsonOutput::writeJson(iModifyTime);
            p->value["sVersion"] = tars::JsonOutput::writeJson(sVersion);
            p->value["sResult"] = tars::JsonOutput::writeJson(sResult);
            if (bSucc != false)
            {
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonValueObjPtr pObj=tars::JsonValueObjPtr::dynamicCast(p);
            tars::JsonInput::readJson(bPatching,pObj->value["bPatching"], true);
            tars::JsonInput::readJson(iPercent,pObj->value["iPercent"], true);
            tars::JsonInput::readJson(iModifyTime,pObj->value["iModifyTime"], true);
            tars::JsonInput::readJson(sVersion,pObj->value["sVersion"], true);
            tars::JsonInput::readJson(sResult,pObj->value["sResult"], true);
    ...
    public:
        ...
        {
            tars::JsonValueObjPtr p = new tars::JsonValueObj();
            p->value["bPreparePatching"] = tars::JsonOutput::writeJson(bPreparePatching);
            p->value["iPercent"] = tars::JsonOutput::writeJson(iPercent);
            p->value["iModifyTime"] = tars::JsonOutput::writeJson(iModifyTime);
            p->value["sVersion"] = tars::JsonOutput::writeJson(sVersion);
            p->value["sResult"] = tars::JsonOutput::writeJson(sResult);
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonValueObjPtr pObj=tars::JsonValueObjPtr::dynamicCast(p);
            tars::JsonInput::readJson(bPreparePatching,pObj->value["bPreparePatching"], true);
            tars::JsonInput::readJson(iPercent,pObj->value["iPercent"], true);
            tars::JsonInput::readJson(iModifyTime,pObj->value["iModifyTime"], true);
            tars::JsonInput::readJson(sVersion,pObj->value["sVersion"], true);
            tars::JsonInput::readJson(sResult,pObj->value["sResult"], true);
    ...
    public:
        ...
        tars::JsonValueObjPtr writeToJson() const
        {
            ...
            p->value["nodeObj"] = tars::JsonOutput::writeJson(nodeObj);
            p->value["endpointIp"] = tars::JsonOutput::writeJson(endpointIp);
            p->value["endpointPort"] = tars::JsonOutput::writeJson(endpointPort);
            p->value["timeOut"] = tars::JsonOutput::writeJson(timeOut);
            p->value["dataDir"] = tars::JsonOutput::writeJson(dataDir);
            if (version != "")
            {
            ...
            if (coreFileSize != "")
            {
                p->value["coreFileSize"] = tars::JsonOutput::writeJson(coreFileSize);
            }
            if (openFiles != 0)
            {
                p->value["openFiles"] = tars::JsonOutput::writeJson(openFiles);
            }
            return p;
        }
        string writeToJsonString()
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonInput::readJson(nodeObj,pObj->value["nodeObj"], true);
            tars::JsonInput::readJson(endpointIp,pObj->value["endpointIp"], true);
            tars::JsonInput::readJson(endpointPort,pObj->value["endpointPort"], true);
            tars::JsonInput::readJson(timeOut,pObj->value["timeOut"], true);
            tars::JsonInput::readJson(dataDir,pObj->value["dataDir"], true);
            tars::JsonInput::readJson(version,pObj->value["version"], false);
            tars::JsonInput::readJson(coreFileSize,pObj->value["coreFileSize"], false);
            tars::JsonInput::readJson(openFiles,pObj->value["openFiles"], false);
        }
        void readFromJsonString(const string & str)
        {
            readFromJson(tars::TC_Json::getValue(str));
    ...
    public:
        ...
        {
            tars::JsonValueObjPtr p = new tars::JsonValueObj();
            p->value["serverState"] = tars::JsonOutput::writeJson((tars::Int32)serverState);
            ...
            p->value["settingState"] = tars::JsonOutput::writeJson((tars::Int32)settingState);
            return p;
        }
        string writeToJsonString()
        {
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonValueObjPtr pObj=tars::JsonValueObjPtr::dynamicCast(p);
            tars::JsonInput::readJson((tars::Int32&)serverState,pObj->value["serverState"], true);
            ...
            tars::JsonInput::readJson((tars::Int32&)settingState,pObj->value["settingState"], false);
        }
        void readFromJsonString(const string & str)
        {
            readFromJson(tars::TC_Json::getValue(str));
    ...
    public:
        ...
        tars::JsonValueObjPtr writeToJson() const
        {
            ...
            p->value["servername"] = tars::JsonOutput::writeJson(servername);
            p->value["nodename"] = tars::JsonOutput::writeJson(nodename);
            p->value["groupname"] = tars::JsonOutput::writeJson(groupname);
            p->value["binname"] = tars::JsonOutput::writeJson(binname);
            p->value["version"] = tars::JsonOutput::writeJson(version);
            p->value["user"] = tars::JsonOutput::writeJson(user);
            p->value["servertype"] = tars::JsonOutput::writeJson(servertype);
            p->value["patchobj"] = tars::JsonOutput::writeJson(patchobj);
            p->value["md5"] = tars::JsonOutput::writeJson(md5);
            if (ostype != "")
            {
                p->value["ostype"] = tars::JsonOutput::writeJson(ostype);
            }
            if (filepath != "")
            {
                p->value["filepath"] = tars::JsonOutput::writeJson(filepath);
            }
            return p;
        }
        string writeToJsonString()
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonInput::readJson(nodename,pObj->value["nodename"], true);
            tars::JsonInput::readJson(groupname,pObj->value["groupname"], true);
            tars::JsonInput::readJson(binname,pObj->value["binname"], true);
            tars::JsonInput::readJson(version,pObj->value["version"], true);
            tars::JsonInput::readJson(user,pObj->value["user"], true);
            tars::JsonInput::readJson(servertype,pObj->value["servertype"], true);
            tars::JsonInput::readJson(patchobj,pObj->value["patchobj"], true);
            tars::JsonInput::readJson(md5,pObj->value["md5"], true);
            tars::JsonInput::readJson(ostype,pObj->value["ostype"], false);
            tars::JsonInput::readJson(filepath,pObj->value["filepath"], false);
        }
        void readFromJsonString(const string & str)
        {
            readFromJson(tars::TC_Json::getValue(str));
    ...
    public:
        ...
        tars::JsonValueObjPtr writeToJson() const
        {
            ...
            p->value["md5"] = tars::JsonOutput::writeJson(md5);
            p->value["ostype"] = tars::JsonOutput::writeJson(ostype);
            p->value["specialNodeList"] = tars::JsonOutput::writeJson(specialNodeList);
            if (filepath != "")
            {
                p->value["filepath"] = tars::JsonOutput::writeJson(filepath);
            }
        ...
        void readFromJson(const tars::JsonValuePtr & p, bool isRequire = true)
        {
            ...
            tars::JsonInput::readJson(patchobj,pObj->value["patchobj"], true);
            tars::JsonInput::readJson(md5,pObj->value["md5"], true);
            tars::JsonInput::readJson(ostype,pObj->value["ostype"], true);
            tars::JsonInput::readJson(specialNodeList,pObj->value["specialNodeList"], true);
            tars::JsonInput::readJson(filepath,pObj->value["filepath"], false);
        }
        void readFromJsonString(const string & str)
        {
